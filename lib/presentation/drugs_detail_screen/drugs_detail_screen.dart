    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Padding(
            ...
            child:
              ...
              Text("lbl_obh_combi", style: CustomTextStyles.titleLargeSemiBold),
              SizedBox(height: 11.v),
              Text("lbl_75ml", style: CustomTextStyles.titleMediumGray50016)
            ])),
        CustomImageView(
      ...
      Row(children: [
        ...
        Padding(
            ...
            child:
                Text("lbl_9_99", style: CustomTextStyles.headlineSmallSemiBold))
      ])
    ]);
  }
