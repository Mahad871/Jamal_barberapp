  ...
  ThemeData _getThemeData() {
    ...
    return ThemeData(
      snackBarTheme: SnackBarThemeData(
        ...
        contentTextStyle: TextThemes.textTheme(colorScheme).bodyMedium,
      ),
...
class CustomColorScheme {
  static final primaryColorScheme = ColorScheme.light(
    ...
    secondaryContainer: Color.fromARGB(70, 61, 61, 61),

    // Error colors
    errorContainer: Color(0XFF2B2E32),
    onError: Color(0XFFD95CF1),
...
class PrimaryColors {
  ...
  Color get green50 => Color.fromARGB(255, 222, 250, 229);
