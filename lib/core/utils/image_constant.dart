class ImageConstant {
  ...
  static String appLogo = '$imagePath/logo transparent bg-01.png';
  ...
  // Sign Up_Success images
  static String imgCheckmarkPrimary = '$imagePath/img_checkmark_primary.svg';

  // Reset Password_Email images
  static String imgClock = '$imagePath/img_clock.svg';

  static String imgCheckmarkGreen600 = '$imagePath/img_checkmark_green_600.svg';

  // Reset Password_Phone images
  static String imgCall = '$imagePath/img_call.svg';

  // Find Doctors images
  static String imgIconLungs = '$imagePath/img_icon_lungs.svg';

  static String imgIconDentist = '$imagePath/img_icon_dentist.svg';

  static String imgIconPsychiatrist = '$imagePath/img_icon_psychiatrist.svg';
  ...
  static String imgEllipse8888x88 = '$imagePath/img_ellipse_88_88x88.png';

  static String imgLocationErrorcontainer =
      '$imagePath/img_location_errorcontainer.svg';
  ...
  // Booking Doctor images
  static String imgCalendar = '$imagePath/img_calendar.svg';

  static String imgShare = '$imagePath/img_share.svg';

  // Chat with Doctor images
  static String imgUVideo = '$imagePath/img_u_video.svg';

  static String imgUPhoneAlt = '$imagePath/img_u_phone_alt.svg';
  ...
  // Audio Call images
  static String imgAudioCall = '$imagePath/img_audio_call.png';

  static String imgImage10 = '$imagePath/img_image_10.png';

  // Video Call images
  static String imgVideoCall = '$imagePath/img_video_call.png';

  static String imgImage = '$imagePath/img_image.png';

  // Schedule images
  static String imgCalendarBlueGray700 =
      '$imagePath/img_calendar_blue_gray_700.svg';

  static String imgSearchBlueGray700 =
      '$imagePath/img_search_blue_gray_700.svg';

  // Schedule_Tab Container images
  static String imgCalendarPrimary = '$imagePath/img_calendar_primary.svg';

  // Message History images
  static String imgCheckmarkGray50018x18 =
      '$imagePath/img_checkmark_gray_500_18x18.svg';

  static String imgPexelsEvelinaZhu5434019 =
      '$imagePath/img_pexels_evelina_zhu_5434019.png';

  // Message History_Tab Container images
  static String imgClockOnprimary = '$imagePath/img_clock_onprimary.svg';
  ...
  // Articles images
  static String imgRectangle460 = '$imagePath/img_rectangle_460.png';

  static String imgBookmarkWhiteA700 = '$imagePath/img_bookmark_white_a700.svg';

  static String imgRectangle458 = '$imagePath/img_rectangle_458.png';
  ...
  static String imgTrashGray500 = '$imagePath/img_trash_gray_500.svg';
  ...
  static String imgGroup183 = '$imagePath/img_group_183.svg';

  static String imgLocationRed700 = '$imagePath/img_location_red_700.svg';
  ...
  static String imgLocationWhiteA700 = '$imagePath/img_location_white_a700.svg';
  ...
  static String imgIcRoundLogout = '$imagePath/img_ic_round_logout.svg';

  static String imgUserPrimary32x32 = '$imagePath/img_user_primary_32x32.svg';
  ...
  static String imgCheckmarkGray500 = '$imagePath/img_checkmark_gray_500.svg';
  ...
  static String imgCheckmarkGray50032x32 =
      '$imagePath/img_checkmark_gray_500_32x32.svg';

  static String imgCalendarGray500 = '$imagePath/img_calendar_gray_500.svg';
  ...
  static String imgVideoCameraWhiteA700 =
      '$imagePath/img_video_camera_white_a700.svg';
  ...
  static String imgComponent1WhiteA700 =
      '$imagePath/img_component_1_white_a700.svg';

  static String imgHomeGray500 = '$imagePath/img_home_gray_500.svg';
